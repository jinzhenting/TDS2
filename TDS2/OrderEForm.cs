...
namespace TDS2
{
    public partial class OrderEForm : Form
    {
        public OrderEForm(DataRow orderRow)
        {
            InitializeComponent();
            try// 图标
            {
                Icon = new Icon(Path.Combine(Application.StartupPath, @"Image\Skin\E.ico"));
            }
        ...
        /// 窗口快捷键
        /// </summary>
        private void OrderEForm_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F6) Close();
        ...
        private void OrderEForm_Resize(object sender, EventArgs e)
        {
            otherListView.Columns[1].Width = Width - 157;
        }
    }
