...
namespace TDS2
{
    public partial class DiskModifyForm : Form
    {
        ...
        private void Save()
        {
            ...
            DiskList.Save(nameLabel.Text, netPathTextBox.Text, localPathComboBox.Text, autoMappingComboBox.Text, windowsAccountComboBox.Text, foreverComboBox.Text, autoCheckComboBox.Text, userNameTextBox.Text, passwordTextBox.Text);
        }
